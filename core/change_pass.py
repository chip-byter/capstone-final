...
from widgets import center_window, MessageBox
# from core.widgets import center_window


class ChangePassForm(ctk.CTkFrame):
    def __init__(self, parent, on_submit=None,):
        ...
        ctk.CTkLabel(self.frame, text="Email").grid(row=1, column=0, sticky="e", padx=10, pady=5)
